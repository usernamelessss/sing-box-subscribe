...
'''
来自:https://github.com/Toperlock/sing-box-subscribe/issues/100
原本vercel使用的是python 3.9，改成3.12版本导致的，重新部署
你是本地的吗，那升级python3.10以上，或者修改 tool.py 文件写法：

    import base64,requests,random,string,re,chardet,paramiko
